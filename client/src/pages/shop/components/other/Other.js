        ...
        <Container className="products">
            <Row className="justify-content-center">
                <Col md={4} className="spacing">
                    <Card classes="center-relative fit-content" classes1="spacing-between" button={<Button to="box" text="Quick view" classes="text-uppercase" />} button1={<Button to="box" text="Add to cart" classes="text-uppercase" />} price="PKR - 0000.00" src="/images/box.png" alt="box" text="box" />
                </Col>
                <Col md={4} className="spacing">
