...
const sizeObj = {
    ...
    Form: function(id, classes) {
        ...
        const [sizesArray, setProductsArray] = useState([]);
        ...
        useEffect(() => {(
            async () => {
                const response = await fetch(`${api}/sizes/TableData`, {
        ...
        function changeNameState(event) {
            ...
            const obj = editObjCheck(sizesArray, value, editObj);
