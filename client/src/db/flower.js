...
const flowerObj = {
    ...
    Form: function(id, classes) {
        ...
        const [flowersArray, setProductsArray] = useState([]);
        ...
        useEffect(() => {(
            async () => {
                const response = await fetch(`${api}/flowers/TableData`, {
        ...
        function changeNameState(event) {
            ...
            const obj = editObjCheck(flowersArray, value, editObj);
        ...
        const onSubmit = async e => {
            ...
            if (queryID === '') {
                ...
                await fetch(`${api}/flowers/update`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
            ...
            if (pressedBtn === 1) {
                ...
                history.push('/admin/flowers/add');
            }
        };
